...
苏打盖 Sodaguide 的一个衍生项目是我写的 [我的 2024 二十年一刻观演报告](https://20yike-report.sodaguide.io/)。这是我第一次写年度报告这种页面，挺考验人的。前端用 Vue 来写，后端接口和数据库使用的是 [laf](https://laf.dev/)。虽然页面做得很辛苦，功能也比较完善，但我觉得还是不够太满意，以后再努力吧。
