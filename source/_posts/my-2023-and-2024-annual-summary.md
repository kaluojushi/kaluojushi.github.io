...
我一直认为，开源框架和个人项目是相辅相成的。当你想做一个个人项目时，你有经验去选择一个最适合的框架；当你想尝试某个框架时，你可能会把它应用在某个实际的场景上。这样做出来的个人项目才是你自己的，不管是成功失败，不管用户数多少，都比那些跟着别人教程做的类似于「高仿某购物网站」好多了。想学一门技术，要让它在自己的项目上落地。

Carlo Tools 上我还用 Vue 写了一些 <a href="https://corecabin.cn/carlo-tools/#/online/" target="_blank">在线工具</a>，比如随机数生成器、时间戳转换等。实际上就是把一些 JS 函数封装在 Vue 组件里以直观的方式暴露给用户使用。有一些工具我自己依然还经常使用，比如这个 <a href="https://corecabin.cn/carlo-tools/#/online/color" target="_blank">颜色转换</a>。
...
2025 年一开始，我就买了 M4 Pro 芯片的新款 Macbook Pro 16。满足了自己的愿望后，在新的一年，给自己提几点希望吧。
